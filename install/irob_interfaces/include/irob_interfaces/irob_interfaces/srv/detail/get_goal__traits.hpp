...
inline void to_yaml(
  const irob_interfaces::srv::GetGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const irob_interfaces::srv::GetGoal_Request & msg)
{
...
[[deprecated("use irob_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const irob_interfaces::srv::GetGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  irob_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use irob_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const irob_interfaces::srv::GetGoal_Response & msg)
{
  return irob_interfaces::srv::to_yaml(msg);
}
