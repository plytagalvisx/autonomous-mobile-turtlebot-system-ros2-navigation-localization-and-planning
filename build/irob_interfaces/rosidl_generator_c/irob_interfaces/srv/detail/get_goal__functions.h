...
#ifndef IROB_INTERFACES__SRV__DETAIL__GET_GOAL__FUNCTIONS_H_
#define IROB_INTERFACES__SRV__DETAIL__GET_GOAL__FUNCTIONS_H_
 ...
 * calls
 * irob_interfaces__srv__GetGoal_Request__init().
...
/**
 * It calls
 * irob_interfaces__srv__GetGoal_Request__fini()
 ...
 * irob_interfaces__srv__GetGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * irob_interfaces__srv__GetGoal_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * irob_interfaces__srv__GetGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irob_interfaces
...
/**
 * It calls
 * irob_interfaces__srv__GetGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_irob_interfaces
...
/**
 * It allocates the memory for the array and calls
 * irob_interfaces__srv__GetGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irob_interfaces
...
/**
 * It calls
 * irob_interfaces__srv__GetGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IROB_INTERFACES__SRV__DETAIL__GET_GOAL__FUNCTIONS_H_
