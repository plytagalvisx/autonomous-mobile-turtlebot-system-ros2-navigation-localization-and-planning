...
static const _GetGoal_Request_type_support_symbol_names_t _GetGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irob_interfaces, srv, GetGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irob_interfaces, srv, GetGoal_Request)),
  }
};
...
{
  return &::irob_interfaces::srv::rosidl_typesupport_cpp::GetGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irob_interfaces, srv, GetGoal_Request)() {
  return get_message_type_support_handle<irob_interfaces::srv::GetGoal_Request>();
}
...
static const _GetGoal_Response_type_support_symbol_names_t _GetGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irob_interfaces, srv, GetGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irob_interfaces, srv, GetGoal_Response)),
  }
};
...
{
  return &::irob_interfaces::srv::rosidl_typesupport_cpp::GetGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irob_interfaces, srv, GetGoal_Response)() {
  return get_message_type_support_handle<irob_interfaces::srv::GetGoal_Response>();
}
...
static const _GetGoal_type_support_symbol_names_t _GetGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irob_interfaces, srv, GetGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irob_interfaces, srv, GetGoal)),
  }
};
...
{
  return &::irob_interfaces::srv::rosidl_typesupport_cpp::GetGoal_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, irob_interfaces, srv, GetGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<irob_interfaces::srv::GetGoal>();
}
