  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irob_interfaces__srv__AtGoal_Request;
    is_plain =
      (
...
static size_t _AtGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irob_interfaces__srv__AtGoal_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = irob_interfaces__srv__AtGoal_Response;
    is_plain =
      (
...
static size_t _AtGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irob_interfaces__srv__AtGoal_Response(
    full_bounded, is_plain, 0);
